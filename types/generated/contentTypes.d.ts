...
export interface ApiMarketLotMarketLot extends Schema.CollectionType {
  collectionName: 'market_lots';
  info: {
    singularName: 'market-lot';
    pluralName: 'market-lots';
    displayName: 'MarketLot';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    ...
    type: Attribute.Enumeration<['Book', 'Video']>;
    videoLink: Attribute.String;
    bookLink: Attribute.String;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::market-lot.market-lot',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiWebbinarrWebbinarr extends Schema.CollectionType {
  ...
  attributes: {
    webinarNumber: Attribute.Integer &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::market-lot.market-lot': ApiMarketLotMarketLot;
